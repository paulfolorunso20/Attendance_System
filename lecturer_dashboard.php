...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css?v=lecturer-live-session-1">
</head>
...
<div class="role-dashboard-shell">
    ...
    <div class="role-dashboard-header">
        ...
        <div class="role-header-actions">
            <a href="profile.php" class="button-link secondary-action">Profile</a>
            <a href="logout.php" class="button-link danger-action">Logout</a>
        </div>
    </div>
    ...
    <?php if ($activeSession) { ?>
        <section class="lecturer-live-session-card" id="dashboardLiveSession" data-session-id="<?php echo e($activeSession["id"]); ?>">
            ...
            <div class="lecturer-live-session-actions">
                <a href="<?php echo e(with_context("create_session.php")); ?>" class="button-link">Open QR Card</a>
                <a href="<?php echo e(with_context("manage_sessions.php")); ?>" class="button-link secondary-action">Manage</a>
            </div>
        </section>
    <?php } ?>
...
const dashboardStatusUrl = <?php echo json_encode(with_context("session_status.php?session_id=" . (int) $activeSession["id"])); ?>;
