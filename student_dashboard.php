...
<div class="role-dashboard-shell">
    ...
    <div class="dashboard-grid role-action-grid">
        ...
        <a href="mark_attendance.php?token=<?php echo urlencode($_SESSION["pending_attendance_token"]); ?>" class="dashboard-card">
            <h3>Scan QR Code</h3>
        ...
        <a href="student_courses.php" class="dashboard-card">
            <h3>My Courses</h3>
            <p>Register the courses you are taking so attendance percentage is calculated correctly.</p>
        </a>

        <a href="student_history.php" class="dashboard-card">
