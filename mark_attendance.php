...
if (isset($_POST['mark']) && $profileComplete && $faceEnrolled) {
    ...
    if ($studentLat === false || $studentLng === false || $studentLat === null || $studentLng === null) {
        ...
        $effectiveRadius = $radius + ($accuracy !== null ? min($accuracy, $maxAllowedAccuracy) : 0);
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css?v=student-gps-accuracy-1">
</head>
<body>
...
<div class="container wide-container">
    ...
    <?php if ($success) { ?>
        ...
        <p><a href="student_history.php">View Attendance History</a></p>
    <?php } ?>
...
function getLocation() {
    ...
    captureBestPosition(function (position) {
        ...
        if (accuracy > demoAccuracyLimit) {
            ...
            locationStatus.textContent = "GPS captured with weak iPhone accuracy: about " + Math.round(accuracy) + " meters. You can submit, but retry GPS if it fails.";
        } else {
